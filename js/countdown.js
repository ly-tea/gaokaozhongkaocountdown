...
zhongkaoDay=new Date(nowyear,5,16,9,0,0);//这个日期是中考时间(当前年份,6月,16日,9点,0分,0秒)
...
if (zhongkaosectimeold<=-226800)//中考结束后两天取消所有显示
{gkcountdown.innerHTML="" ;
} else if (gaokaosectimeold<=-226800)//高结束后两天恢复取消高考显示
